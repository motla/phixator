...
final class PHUIButtonView extends AphrontTagView {
    ...
    public function setCustomClasses(array $classes) {
    ...
    public function setDropdownMenuID($id) {
        ...
        $this->addSigil('phui-dropdown-menu');
        $this->setMetadata(array('menuID' => $id,));
    ...
    protected function getTagAttributes() {
        ...
        $classes[] = implode(' ', $this->getCustomClasses());

        return array('class' => $classes, 'href' => $this->href, 'name' => $this->name, 'title' => $this->title, 'sigil' => $sigil, 'meta' => $meta, 'type' => $this->getButtonType(), 'value' => $this->getValue(),);
    }
    ...
    protected function getTagContent() {
        ...
        if ($this->icon) {
            ...
            $subtext = null;
            if ($this->subtext) {
                $subtext = phutil_tag('div', array('class' => 'phui-button-subtext',), $this->subtext);
            }
